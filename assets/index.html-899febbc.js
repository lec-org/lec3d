import{_ as e,p as n,q as i,a1 as s}from"./framework-7e09d608.js";const d={},l=s(`<h1 id="api" tabindex="-1"><a class="header-anchor" href="#api" aria-hidden="true">#</a> API</h1><h3 id="init" tabindex="-1"><a class="header-anchor" href="#init" aria-hidden="true">#</a> init</h3><blockquote><p>快速初始化，并返回相机、场景、渲染器等对象和添加鼠标控制、获取鼠标点击对象等方法</p></blockquote><p><strong>示例</strong></p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>import lec3d from &quot;@trickle/lec3d&quot;;
